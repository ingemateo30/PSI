                            ...
                            <table className="w-full bg-white text-left">
                                ...
                                <tbody>
                                    <tr className="border-b hover:bg-gray-50 transition-colors">
                                        <td className="py-4 px-6 font-medium">San Gil</td>
                                        ...
                                        <td className="py-4 px-6">Carrera 9 #9-94</td>
                                    </tr>
                                    <tr className="border-b hover:bg-gray-50 transition-colors">
                                        <td className="py-4 px-6 font-medium">Socorro</td>
                                        <td className="py-4 px-6">
                                            <div className="flex items-center">
                                                <span className="text-[#e31e25] mr-2">📞</span>
                                                7273300
                                        ...
                                        <td className="py-4 px-6">Carrera 14 #10-45</td>
                                    </tr>
                                    <tr className="border-b hover:bg-gray-50 transition-colors">
                                        <td className="py-4 px-6 font-medium">Campoalegre</td>
                                        <td className="py-4 px-6">
                                            <div className="flex items-center">
                                                <span className="text-[#e31e25] mr-2">📞</span>
                                                3182711387
                                        ...
                                        <td className="py-4 px-6">Carrera 9 17-51</td>
                                    </tr>
                                    <tr className="hover:bg-gray-50 transition-colors">
                                        <td className="py-4 px-6 font-medium">Piedecuesta</td>
                                        <td className="py-4 px-6">
                                            <div className="flex items-center">
                                                <span className="text-[#e31e25] mr-2">📞</span>
                                                3187305239
                                        ...
                                        <td className="py-4 px-6">Carrera 7 4-63</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
